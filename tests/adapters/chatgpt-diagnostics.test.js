...
import { startManualScrollDiagnostics, resetDiagnostics } from '../../src/adapters/chatgpt/diagnostics.js';
describe('ChatGPT Manual Scroll Diagnostics v2', () => {
  ...
  it('detects container replacement (CASE E)', () => {
    ...
    Object.defineProperty(c1, 'scrollTop', {
      value: 0,
      writable: true
    });
    startManualScrollDiagnostics(document);
    const wheel1 = new WheelEvent('wheel');
    Object.defineProperty(wheel1, 'composedPath', {
      value: () => [c1]
    });
    ...
    Object.defineProperty(c2, 'scrollTop', {
      value: 0,
      writable: true
    });
    const wheel2 = new WheelEvent('wheel');
    Object.defineProperty(wheel2, 'composedPath', {
      value: () => [c2]
    });
  ...
  it('does not log PII text', () => {
    ...
    c1.scrollTop = 10;
    vi.advanceTimersByTime(250);
    const logs = Logger.info.mock.calls.map(call => JSON.stringify(call)).join(' ');
