...
import { injectChatGPT } from '@/adapters/chatgpt/injector.js';
...
describe('End-to-End Flow: Claude → ChatGPT Handoff', () => {
  ...
  it('completes the full handoff cycle from Claude extraction to ChatGPT injection', async () => {
    ...
    const claudeDom = new JSDOM(claudeHtml, {
    ...
    const chatgptDom = new JSDOM('<!DOCTYPE html><html><body><div id="prompt-textarea" contenteditable="true"></div></body></html>', {
