...
export const Popup = () => {
  ...
  const handleTriggerHandoff = async dest => {
    try {
  ...
  return <div className="w-[260px] bg-[#09090B] text-[#F4F4F6] p-3.5 font-sans antialiased select-none border border-[#232326] rounded-xl shadow-2xl">
      ...
      {loading ? <div className="py-4 flex items-center justify-center text-[#71717A] gap-2 text-xs">
          ...
          {conversationState && conversationState.isInConversation && <div className="mb-3 p-2.5 rounded-lg bg-[#141416] border border-[#232326]">
              ...
              <div className="text-[11px] text-[#A1A1AA] flex items-center justify-between">
                ...
                {conversationState.isStreaming && <span className="text-[#F59E0B] flex items-center gap-1">
        ...
        return <button key={destAdapter.id} onClick={() => handleTriggerHandoff(destAdapter.id)} disabled={transferring} className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-[#111113] border border-[#232326] hover:bg-[#18181B] hover:border-[#36363A] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-600 transition-all duration-150 cursor-pointer group text-left">
                ...
                {transferring && pendingDest === destAdapter.id ? <SpinnerIcon size={13} className="text-[#3B82F6]" /> : transferSuccess && pendingDest === destAdapter.id ? <CheckIcon size={13} className="text-[#10A37F]" /> : <TransitArrow size={13} className="text-[#52525B] group-hover:text-[#D4D4D8] group-hover:translate-x-0.5 transition-all duration-150" />}
              </button>;
      })}
