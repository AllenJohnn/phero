...
`;
export function mountFloatingPill(sourceProvider) {
  ...
  root.render(React.createElement(FloatingPill, {
    sourceProvider
  }));
  Logger.info('Mounted PHERO floating action pill in Shadow DOM', {
    sourceProvider
  });
  return () => {
    root.unmount();
